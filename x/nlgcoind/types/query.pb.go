...
func (*QueryParamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_4dce0c0429eef272, []int{0}
}
...
func (*QueryParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_4dce0c0429eef272, []int{1}
}
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "nlgcoind.nlgcoind.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "nlgcoind.nlgcoind.QueryParamsResponse")
}

func init() { proto.RegisterFile("nlgcoind/query.proto", fileDescriptor_4dce0c0429eef272) }

var fileDescriptor_4dce0c0429eef272 = []byte{
	// 279 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x12, 0xc9, 0xcb, 0x49, 0x4f,
	0xce, 0xcf, 0xcc, 0x4b, 0xd1, 0x2f, 0x2c, 0x4d, 0x2d, 0xaa, 0xd4, 0x2b, 0x28, 0xca, 0x2f, 0xc9,
	...
	0x54, 0x16, 0xa4, 0x16, 0x27, 0xb1, 0x81, 0xc3, 0xc9, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0x6a,
	0x58, 0xd4, 0x60, 0xc9, 0x01, 0x00, 0x00,
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/nlgcoind.nlgcoind.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nlgcoind.nlgcoind.Query/Params",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "nlgcoind.nlgcoind.Query",
